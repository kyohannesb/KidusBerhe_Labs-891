...
\hypersetup{
  pdftitle={Written Answers for Lab 1},
  pdfauthor={Kidus Berhe},
  hidelinks,
...
\title{Written Answers for Lab 1}
\author{Kidus Berhe}
\date{9/23/2021}
...
\item
  ...
  sf::st\_intersection(d.stations, del.counties)
  sf::st\_intersection(del.counties, d.stations)
